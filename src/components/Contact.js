                    ...
                    <div className="contact-box">
                        <motion.div className="left-box" initial={{ opacity: 0, y: '-50px' }} whileInView={verticalLeft}>
                            ...
                            <div className="contact-hello">
                                <p>Say Hello</p>
                                <Link className='hello-links' to="https://wa.me/+919389867993" target='_blank'>wa.me/9389867993</Link>
                                <Link className='hello-links' to="mailto:poojasisodia406@gmail.com" target='_blank'>poojasisodia406@gmail.com</Link>
                            </div>
                        </motion.div>
